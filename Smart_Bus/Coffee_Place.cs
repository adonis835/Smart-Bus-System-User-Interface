...
namespace Smart_Bus
{
    public partial class Coffee_Place : Form
    {
        ...
        public Coffee_Place(Order orderForm)
        {
            InitializeComponent();
        ...
        private void Coffee_Place_Load(object sender, EventArgs e)
        {
            ...
            List<Item> items = new List<Item>()
            {
                ...
                new Item() { Name = "Soda 330ml", Description = "Classic soda drink", img = Properties.Resources.soda, Categories = Categories.Soft_Drinks,price = 6.50f },
                ...
                new Item() { Name = "Hot Chocolate", Description = "Rich cocoa and milk", img = Properties.Resources.hot_chocolate, Categories = Categories.Beverages,price = 6.00f },
                new Item() { Name = "Hot Macha Latte", Description = "Smooth green tea blended with steamed milk", img = Properties.Resources.macha, Categories = Categories.Beverages,price = 7.00f },
                ...
                new Item() { Name = "Muffin", Description = "A small, soft, and slightly sweet baked treat", img = Properties.Resources.muffin, Categories = Categories.Light_Meals,price = 10.50f },
        ...
        private void Coffee_Place_FormClosing(object sender, FormClosingEventArgs e)
        {
            orderform.Show();
        }
        public void UpdateCartButton()
        {
            button2.Enabled = globalCart.Count > 0;
        }
