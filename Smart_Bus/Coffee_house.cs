...
namespace Smart_Bus
{
    ...
    public partial class Coffee_house : Form
    {
        ...
        public Coffee_house(Order orderForm)
        {
            InitializeComponent();
        ...
        private void Coffee_house_Load(object sender, EventArgs e)
        {
        ...
        private void Coffee_house_FormClosing(object sender, FormClosingEventArgs e)
        {
            orderform.Show();
        }
